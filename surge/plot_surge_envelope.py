...
parser.add_argument('-f', type=str, help='Name of file containing z envelope (Created by make_surge_envelope)', default='./roms_zenv.nc')
parser.add_argument('-o', type=str, help='Name of output image .png file', default='surge_envelope.png')
...
f.savefig( os.path.join( args.proj, args.o) )